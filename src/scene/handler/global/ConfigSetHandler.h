...
#ifndef DATA_INSIGHT_CORE_SCENE_GLOBAL_CONFIG_SET_HANDLER_H
#define DATA_INSIGHT_CORE_SCENE_GLOBAL_CONFIG_SET_HANDLER_H
...
#endif // DATA_INSIGHT_CORE_SCENE_GLOBAL_CONFIG_SET_HANDLER_H
