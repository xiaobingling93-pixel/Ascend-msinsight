...
public:
    ...
    static void SetHarmonyConfigJson(const HarmonyConfig &config, json_t &jsonHarmonyConfig);
    static void SetHarmonyConfigStruct(const json_t &jsonHarmonyConfig, HarmonyConfig &config);
    // request
