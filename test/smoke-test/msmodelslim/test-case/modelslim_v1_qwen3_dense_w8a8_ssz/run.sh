...
rm -rf $PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_ssz
...
msmodelslim quant \
    ...
    --save_path $PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_ssz \
    --device npu \
    --model_type Qwen3-14B \
    --config_path $PROJECT_PATH/test-case/modelslim_v1_qwen3_dense_w8a8_ssz/dense-w8a8-ssz-v1.yaml \
    --trust_remote_code True

# 配置待检查的路径和文件列表
TARGET_PATH="$PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_ssz"  # 修改为实际路径
FILES=(
    "config.json"
...
if [ "$all_exist" = true ]; then
    echo modelslim_v1_qwen3_dense_w8a8_ssz: Success
else
    echo modelslim_v1_qwen3_dense_w8a8_ssz: Failed
    run_ok=$ret_failed
fi
