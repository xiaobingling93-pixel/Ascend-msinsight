...
# 用例名（用于打屏和指定输出路径）
CASE_NAME=modelslim_v1_qwen3_dense_w8a8
...
rm $PROJECT_PATH/test-case/$CASE_NAME/dense-w8a8-v1.yaml
cp $MSMODELSLIM_SOURCE_DIR/docs/功能指南/一键量化/example/dense-w8a8-v1.yaml .
chmod 640 $PROJECT_PATH/test-case/$CASE_NAME/dense-w8a8-v1.yaml
...
msmodelslim quant \
    ...
    --config_path $PROJECT_PATH/test-case/$CASE_NAME/dense-w8a8-v1.yaml \
