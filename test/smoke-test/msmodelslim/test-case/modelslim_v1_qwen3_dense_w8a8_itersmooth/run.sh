...
rm -rf $PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_itersmooth
...
msmodelslim quant \
    ...
    --save_path $PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_itersmooth \
    --device npu \
    --model_type Qwen3-14B \
    --config_path $PROJECT_PATH/test-case/modelslim_v1_qwen3_dense_w8a8_itersmooth/dense-w8a8-itersmooth-v1.yaml \
    --trust_remote_code True

# 配置待检查的路径和文件列表
TARGET_PATH="$PROJECT_PATH/output/modelslim_v1_qwen3_dense_w8a8_itersmooth"  # 修改为实际路径
FILES=(
    "config.json"
...
if [ "$all_exist" = true ]; then
    echo modelslim_v1_qwen3_dense_w8a8_itersmooth: Success
else
    echo modelslim_v1_qwen3_dense_w8a8_itersmooth: Failed
    run_ok=$ret_failed
fi
