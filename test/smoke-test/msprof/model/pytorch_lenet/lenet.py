...
class LeNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(32*5*5, 120).to(torch.float16)
        self.fc2 = nn.Linear(120, 84).to(torch.float16)
        self.fc3 = nn.Linear(84, 10).to(torch.float16)
...
def TestLeNetE2E():
    ...
    with torch_npu.profiler.profile(
        ...
        on_trace_ready=torch_npu.profiler.tensorboard_trace_handler(args.prof_path),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prof_path", "-d", default=None, help="root dir of PROF_* data")
