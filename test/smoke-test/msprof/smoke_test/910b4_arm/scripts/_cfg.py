...
class ConfigPaths:
    ...
    MindSporeLlama2 = os.path.join(model_path, "mindformers/scripts")
    PytorchLlama2Single = os.path.join(model_path, "op_test/01-Inference/LLAMA2/LLAMA2_ID4322_for_PyTorch")
    PytorchLlama2Graph = os.path.join(model_path,
                                       "op_test/01-Inference/LLAMA2/LLAMA2_ID4322_for_PyTorch_graph")
    ModellinkLlama2Mc2 = os.path.join(model_path, "ModelLink")
    ModellinkLlama2 = os.path.join(model_path, "ModelLink")
    MindSpeedLLMGPTMc2 = os.path.join(model_path, "MindSpeed-LLM")
    AtbSingleOp = os.path.join(model_path, "ascend-transformer-boost/")
        ...
        "op_summary": {
            ...
            "task-based": {
                ...
                "Memory": "Model ID,Task ID,Stream ID,Op Name,OP Type,OP State,Task Type,"
                          ...
                          "aiv_time(us),aiv_total_cycles,aiv_ub_read_bw(GB/s),aiv_ub_write_bw(GB/s),aiv_main_mem_read_bw(GB/s),"
