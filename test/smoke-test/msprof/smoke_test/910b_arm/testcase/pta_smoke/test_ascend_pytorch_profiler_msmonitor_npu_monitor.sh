...
main(){
    ...
    ./dyno --certs-dir NO_CERTS npu-monitor --npu-monitor-start --report-interval-s 5 --mspti-activity-kind Marker,Kernel,API,Communication --log-file ${testcase_result_dir}/npu_monitor > ${testcase_result_dir}/dyno.txt 2>&1 &
    if [ 0 -ne $? ]; then
