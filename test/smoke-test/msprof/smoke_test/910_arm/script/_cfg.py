...
class ConfigPaths:
    ...
    python_env = "source /root/miniconda3/bin/activate /root/miniconda3/envs/smoke_test_env"
    ...
    op_cost_baseline_path = "/home/msprof_smoke_test/smoke_test/910_arm/baseline/op_meantime_baseline_910.json"
    op_statistic_json_path = "/home/msprof_smoke_test/compare_profiling/op_statistic_avg_time.json"
    msprof_db_path = os.path.join(model_path, "Msprof_db")
