...
class ConfigPaths:
    ...
    fpBpTensorFlow_path = ""
    op_cost_baseline_path = "/home/msprof_smoke_test/smoke_test/310_arm/baseline/op_meantime_baseline_310arm.json"
...
class ConfigValues:
    ...
    acljson_switch = ["aicpu=on", "l2=off", "hccl=off", "task_time=on", "ascendcl=on", "runtime_api=on",
                      "sys_hardware_mem_freq=on", "llc_profiling=bandwidth",
    ...
    tensorflow_switch = ["hccl=off", "aicpu=on", "l2=on", "msproftx=off", "task_time=on", "runtime_api=on",
                         "sys_hardware_mem_freq=on", "llc_profiling=capacity",
                         "sys_interconnection_freq=on", "dvpp_freq=on", "host_sys=cpu,mem", "host_sys_usage=cpu,mem",
    ...
    msprofbin_switch = ["ascendcl=on", "model-execution=on", "runtime-api=on", "task-time=on", "aicpu=on",
                        ...
                        "dvpp-profiling=on", "llc-profiling=capacity", "aic-mode=task-based",
...
class ConfigCmd:
    ...
    all_switch = "{}; {}; " \
                 ...
                 "--sys-pid-sampling-freq=10 --dvpp-profiling=on " \
